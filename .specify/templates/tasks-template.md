...
- [ ] T010 Enforce SQL connection security flags and pooling configuration
- [ ] T011 [P] Implement RBAC roles (`Admin`, `Employee`, `Auditor`) and least-privilege access matrix
- [ ] T012 [P] Configure audit logging for all create/update/delete operations
- [ ] T013 Define schema version-lock policy and migration rollback validation
- [ ] T014 Configure query timeout/resource limits and indexing baseline for key IDs
- [ ] T015 Configure TLS 1.2+ data transit and encryption-at-rest controls
- [ ] T016 Add SQL health checks and admin alert routing for critical events
